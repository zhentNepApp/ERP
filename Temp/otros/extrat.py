...
# # 🗂️ Carga el texto del RUT
# texto = open(r"C:\Users\USUARIO\OneDrive - netapplications.com.co\RPA\AA\Desayuno\Outputs\Aprovados\RUT.txt", encoding="utf-8").read()

# # 🌐 URL del servidor Flask en Colab vía ngrok
# url = "https://solid-exactly-mite.ngrok-free.app/procesar"

# # 🛡️ Header para evitar el warning de ngrok
# headers = {
#     "ngrok-skip-browser-warning": "true"
# }

# # 🚀 Enviar la solicitud POST con verificación SSL desactivada (solo para pruebas)
# try:
#     response = requests.post(url, json={"texto": texto}, headers=headers, verify=False)

#     # ✅ Mostrar el resultado
#     print(response.status_code)
#     print(response.json().get("resultado", "No se encontró resultado"))

# except requests.exceptions.RequestException as e:
#     print(f"❌ Error en la solicitud: {e}")
#     print(response.status_code)
#     print(response.json())  # ← esto mostrará {"error": "..."} si hubo un fallo
